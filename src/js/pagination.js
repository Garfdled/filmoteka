...
// // Function to cancel all Axios requests
// const cancelAllRequests = () => {
//   // Iterate through Axios interceptors
//   axios.interceptors.request.handlers.forEach((interceptor) => {
//       // If the interceptor has a cancel token, cancel the request
//       if (interceptor.request.cancelToken) {
//           interceptor.request.cancelToken.cancel('Request canceled due to window unload');
//       }
//   });
// };
